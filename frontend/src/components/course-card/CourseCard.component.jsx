    ...
    <div className="course-card-section py-lg">
      <Container>
        <Row>
            ...
            <div className="course-card ">
              ...
              <div className="course-card-course-content">
                <Row>
                  <Col>
                    <p>
                      <i className="fa fa-check-square-o"></i> High quality
                      video and awesome explanation for every topic
                    </p>
                    <p>
                      <i className="fa fa-check-square-o"></i> High quality
                      video and awesome explanation for every topic
                ...
                <div className="course-card-buynowbutton">
                  <Button className="rounded-0 button-big bg-default text-white">
                    <Link className="text-white" to="/checkout">
                      Buy Now{" "}
                      <span className="text-danger course-price">99 $</span>
                    </Link>
                  </Button>
                </div>
              </div>
          ...
          {/* course Start */}
          <Col className="mt-6 my-md-0 my-lg-0 col-12 col-md-12 col-lg-6">
            <div className="course-card">
              <div className="player-wrapper course-card-preview-video">
                <ReactPlayer
                  width="100%"
          ...
          {/* course end */}
          {/* course Start */}
          <Col className="col-12 col-md-12 col-lg-6 my-md">
            <div className="course-card ">
              <div className="player-wrapper course-card-preview-video">
                <ReactPlayer
                  width="100%"
